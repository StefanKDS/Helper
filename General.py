...
def launchTensorBoard(log_dir):
    ...
    t = threading.Thread(target=launchTensorBoard(log_dir), args=([]))
    t.start()
    return
...
def get_std_callbacks(projectname):
    # CALLBACKS
    ...
    tensorboard = create_tensorboard_callback('Auswertung/', projectname)
